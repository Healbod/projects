...
* карта с визуализацией реального и прогнозируемого спроса на такси в выбираемый пользователем момент времени (скачать и ознакомиться с исполняемым файлом для пользователя можно по [ссылке](taxi_NY/data/df_regions/predict_map.html))

![predict_map](taxi_NY/data/df_regions/predict_map.jpg "Predict_map")

* временной ряд фактического и прогнозируемого спроса на такси в выбираемой области (скачать и ознакомиться с исполняемым файлом для пользователя можно по [ссылке](taxi_NY/data/df_regions/predict_figure.html))
