...
По результатам применения различных моделей получили следующее
...
> 
> В ходе выполнения проекта:
> * научились извлекать признаки из сырых данных и использовать различные библиотеки, модели и средства для анализа данных
> * применили различные модели машинного обучения и проанализировали как добавление различных признаков влияет на качество прогноза
